...
convert -density 200 "$1" -depth 8 -strip -background white -alpha off "$filename"%d.tif
...
/mnt/ramdisk/bin/tesseract "$filename".sv "$2" -l ron --oem 1 --psm 1 --tessdata-dir /mnt/ramdisk/tessfast
